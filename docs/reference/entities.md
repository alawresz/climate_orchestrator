...
| Event notifications         | On      | Raise self-clearing notifications in HA's notification panel for frost protection, a degraded status, and an AC paused for a full condensate tank. [Bus events](../guides/services-automations.md#events) fire regardless of this switch.                                                                                                                                                                              |
